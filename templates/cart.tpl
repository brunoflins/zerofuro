                ...
                <div class="cart-contents cart-table js-cart-contents">             
                    ...
                    <ul class="js-cart-item {% if item.product.is_non_shippable %}js-cart-item-non-shippable{% else %}js-cart-item-shippable{% endif %} cart-table-row h5 font-body-xs row-fluid m-top-half-xs" data-item-id="{{ item.id }}" data-store="cart-item-{{ item.product.id }}">
                        ...
                        <li class="col-quantity cart-quantity span2 m-top m-none-xs">
                            ...
                            <button type="button" class="js-cart-quantity-btn cart-quantity-btn" onclick="adicionar()">
                            ...
                            <div class="cart-quantity-input-container d-inline-block pull-left">                               
                                ...
                                <input type="number" id="quantidade" name="quantity[{{ item.id }}]" value="{{ item.quantity }}" pattern="\d*" data-item-id="{{ item.id }}" onKeyUp="LS.resetItems();" class="js-cart-quantity-input cart-quantity-input" />
                            </div>
                            <button type="button" class="js-cart-quantity-btn cart-quantity-btn" onclick="LS.plusQuantity({{ item.id }}, 2)">
                                <div class="cart-quantity-svg-icon svg-icon-text">
                            ...
                            <script>
                                function adicionar() {
                                    document.getElementById('quantidade').value = document.getElementById('quantidade').value -2 
                                    LS.resetItems();
                                }
                            </script>
